...
## 
```javascript
this.content = response.data.data[0].content //axios
this.content = response.body.data[0].content //vue-resource
```
...
## vue推荐使用[axios](https://github.com/mzabriskie/axios)，不使用vue-resource
